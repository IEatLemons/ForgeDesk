...
contextBridge.exposeInMainWorld('forgeDesk', {
  ...
  listAiProjectResourceLinks: (query?: { projectId?: string; providerId?: string }) => ipcRenderer.invoke('ai-project-resource-links:list', query),
  saveAiProjectResourceLink: (input: AiProjectResourceLinkInput) => ipcRenderer.invoke('ai-project-resource-link:save', input),
  saveAiProjectResourceLinks: (input: { providerId: string; projectId: string; resourcePaths: string[] }) => ipcRenderer.invoke('ai-project-resource-links:save', input),
  deleteAiProjectResourceLink: (input: { providerId: string; resourcePath: string }) => ipcRenderer.invoke('ai-project-resource-link:delete', input),
