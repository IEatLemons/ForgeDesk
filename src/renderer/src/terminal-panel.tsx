...
function getTerminalTheme(resolvedTheme: ResolvedTheme): NonNullable<Terminal['options']['theme']> {
...
function TerminalPane({ active, resolvedTheme, session, onDispose, onReady, onResize, onWriteError }: TerminalPaneProps): JSX.Element {
